...
namespace pokemon.MVVM.ViewModel
{
    public class LoseVM : BaseVM
    {
        ...
        public LoseVM(ExerciceMonsterContext context, ObservableCollection<Monster> playerPokemonList, ObservableCollection<Monster> enemyPokemonList)
        {
            _context = context;
